The VUMAT subroutine for implementing the explicit phase field model.
...
Note: Due to a typographical error, the term related to the AT2 model in Eq.(23) in the manuscript should not include the factor of 1/2. The provided code is correct.
